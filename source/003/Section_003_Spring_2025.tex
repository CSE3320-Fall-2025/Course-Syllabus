...
\begin{center}
{\bf CSE 3320.003 Operating Systems \linebreak{} Spring 2025\linebreak{} \ \
}
\end{center}
...
\vskip.25in
 ...
 \vskip.25in
\noindent\textbf{Section Information:} CSE3320 Section 003
 \vskip.25in
\noindent\textbf{Time and Place of Class Meetings}:  MW 5:30PM - 6:50 PM WH 404
\vskip.25in
...
https://join.slack.com/t/cse3320/shared\_invite/zt-2xfneugr5-Jns9kmZWQnjlKid\_Wsox9w
...
\begin{flushleft}
Drop Deadline \dotfill Apr. 4\\
Exam 1 \dotfill Feb. 24th (tentative date)\\
Exam 2 \dotfill Mar. 26th (tentative date)\\
Final  \dotfill May 7 at 5:30 – 8 p.m.(firm date)\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
...
\includegraphics[scale=.4]{source/003/evacuation.png} 
...
\center{
\includegraphics[scale=0.75]{source/003/schedule.png} 
}
\end{document}
