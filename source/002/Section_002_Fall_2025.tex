...
\begin{center}
{\bf CSE 3320.002 Operating Systems \linebreak{} Fall 2025\linebreak{} \ \
}
\end{center}
...
\vskip.25in
\noindent\textbf{Office Hours:} Friday 8:30AM - 11:30AM 
\vskip.25in
...
\noindent\textbf{Section Information:} CSE3320 Section 002
 \vskip.25in
\noindent\textbf{Time and Place of Class Meetings}:  MW 7:00 PM - 8:20 PM NH 202
\vskip.25in
...
\vskip.25in
\noindent\textbf{Descriptions of major assignments}: There will be two exams plus a final exam.  There will be approximately 4 programming assignments and 2-4 homework assignments.  Quizzes may be given as needed.  Programming assignments, and any homework assignments are not considered major works. All dates will be posted in advance on the course Canvas site.  The final exam date is set by the university and is non-negotiable.
\vskip.25in
%\pagebreak
\noindent\textbf{Important Dates}:
\begin{center} \begin{minipage}{5in}
\begin{flushleft}
Drop Deadline \dotfill Oct. 31st.\\
Exam 1 \dotfill Sep. 29th (tentative)\\
Exam 2 \dotfill Nov. 5th (tentative)\\
Final  \dotfill Dec. 8th at 8:15pm – 10:45 p.m.(fixed)\\
\end{flushleft}
\end{minipage}
\end{center}
\vskip.25in
...
\cline{1-2}
Programs and Quizzes  &48\% &  &  &  \\ \cline{1-2}
Homework   & 2\% & & &  \\ \cline{1-2}
...
\noindent Use of GitHub Copilot, Claude, ChatGPT or any other LLM AI will result in a 0 on the assignment and a referral to the Office of Student Conduct.  This includes the use of generative AI to re-factor, format, clean-up, or comment code. It is the responsibility of each student to ensure that all work submitted for this class is their own original work, written and completed without the use of AI or other automated coding tools.  Leaving generative AI tools enabled, even unintentionally, will not excuse a violation of this policy.
...
\vskip.25in
\noindent\textbf{Course Schedule}: A tentative course schedule can be found on the course website and below. Keep in mind
...
\center{
%\includegraphics[scale=0.75]{source/002/schedule.png} 
}
\begin{longtable}{@{} P{2.8cm} P{2.0cm} P{7.2cm} P{3.0cm} @{}}
\toprule
\textbf{Unit} & \textbf{Date} & \textbf{Topics} & \textbf{Assigned / Due} \\
\midrule
\endfirsthead
\toprule
\textbf{Unit} & \textbf{Date} & \textbf{Topics} & \textbf{Assigned / Due} \\
...
Introduction to CSE 3320 and Operating Systems & Wed 08/20 & Chapter 2 — Operating System Architectures & Homework 01 Assigned \\

Virtualization & Mon 08/25 & Chapter 7 — Virtualization &  \\
Virtualization & Wed 08/27 & Chapter 7 — Virtualization &  \\

Processes & Mon 09/01 & Labor Day — No class &  \\
Processes & Wed 09/03 & Chapter 8 — Process Concepts & Homework 01 Due \\
Processes & Mon 09/08 & Chapter 8 — Process Scheduling & Program 1 Assigned \\
Processes & Wed 09/10 & Chapter 8 — Threads &  \\
Processes & Mon 09/15 & Chapter 8 — Threads &  \\
Processes & Wed 09/17 & Chapter 9 — Synchronization and Deadlocks &  \\
Processes & Mon 09/22 & Chapter 9 — Synchronization and Deadlocks &  \\
Processes & Wed 09/24 & Exam 1 Review & Program 1 Due \\
Processes & Mon 09/29 & Exam 1 &  \\

Memory & Wed 10/01 & Chapter 10 — Memory Management & Program 2 Assigned \\
Memory & Mon 10/06 & Chapter 11 — Advanced Memory Management &  \\
Memory & Wed 10/08 & Chapter 11 — Advanced Memory Management &  \\
Memory & Mon 10/13 & Chapter 12 — File Systems &  \\
Memory & Wed 10/15 & Chapter 12 — File Systems &  \\
...
Final Exam & Mon 12/08 & Final Exam — Section 001, 8:15PM–10:45PM &  \\
\end{longtable}
\end{document}
